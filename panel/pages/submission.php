...
<input type="text" id="type" name="type" <?php echo 'value="' . $mod->compatibility . '"'; ?> /></br>
<label>Dependencies
<span class="small" id="dependencytext">Comma separated</span>
</label>
<input type="text" id="dependencies" name="dependencies" <?php echo 'value="' . implode(', ',$mod->availability) . '"'; ?> /></br>
<label>Versions
