...
<div id="main">
	...
	<p class="select">
		...
		<span style="text-size:30px; font-style:italic">
			Last Updated: <?php $content = file('list/1.6/changelog_1.6.4.html'); echo $content[1]; ?>
		</span><br/>

		<span class="selection">
			<a href="list/1.6/1.6.4.php">1.6.4 List</a><br/>
			<a href="list/1.6/changelog_1.6.4.html">Changelog</a>
		</span><br/><br/>
